...
class AppTheme {
  ...
  static const Color surface = Color(0xFF0A0A0A); // Slightly lighter for subtle depth
  static const Color accent = Color(0xFF3ECF8E); // Supabase Emerald Green
    ...
    return ThemeData(
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(8), // Sharper corners like Vercel
          ),
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: Colors.white.withOpacity(0.08)), // Subtle border
        ),
      ),
